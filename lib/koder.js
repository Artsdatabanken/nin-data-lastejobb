...
function artskode(scientificNameId, scientificName) {
  if (scientificNameId === 0) return config.prefix.taxon.replace('_', '')
  return config.prefix.taxon + scientificNameId
