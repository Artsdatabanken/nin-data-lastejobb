...
let hovedtyper = readJson(config.datakilde.NA_hovedtyper)
let mi = readJson(config.getDataPath('2_konvertering/MI_variasjon.json'))
...
writeJson(config.getDataPath(__filename), r)
